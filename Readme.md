...
`
wget https://raw.githubusercontent.com/vpsiix/AutoScriptDebian/master/privoxy-adblock.sh && chmod +x privoxy-adblock.sh && ./privoxy-adblock.sh && rm -f privoxy-adblock.sh
`
